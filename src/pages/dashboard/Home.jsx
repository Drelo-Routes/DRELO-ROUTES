            ...
            <div className="absolute z-30 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
              <Link to="/aichat">
                <img
                  src={logo}
                  alt="DreLoBot"
                  className="w-24 h-24 md:w-32 md:h-32 rounded-full object-cover shadow-lg cursor-pointer"
                />
              </Link>
            </div>

            {[ 
              { label: "Guide", icon: "📖", btn: "Read", pos: "top-[8%] left-1/2", link: "/map" },
